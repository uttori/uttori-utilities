...
<dt><a href="#readFile">readFile(folder, name, extension, encoding)</a> ⇒ <code>Promise</code></dt>
...
<dt><a href="#readJSON">readJSON(folder, name, extension, encoding)</a> ⇒ <code>Promise</code></dt>
...
<dt><a href="#readFolder">readFolder(folder)</a> ⇒ <code>Promise</code></dt>
...
<dt><a href="#writeFile">writeFile(folder, name, extension, content, encoding)</a></dt>
<dd><p>Write a file to the file system.</p>
</dd>
<dt><a href="#writeFileSync">writeFileSync(folder, name, extension, content, encoding)</a></dt>
...
## readFile(folder, name, extension, encoding) ⇒ <code>Promise</code>
Reads a file from the file system.

**Kind**: global function  
**Returns**: <code>Promise</code> - - The parsed JSON file contents.  
...
## readJSON(folder, name, extension, encoding) ⇒ <code>Promise</code>
...
## readFolder(folder) ⇒ <code>Promise</code>
Reads a folder from the file system.

**Kind**: global function  
**Returns**: <code>Promise</code> - - The file paths found in the folder.  
...
## writeFile(folder, name, extension, content, encoding)
...
| extension | <code>string</code> |  | The file extension of the file to be written. |
| content | <code>string</code> |  | The content of the file to be written. |
| encoding | <code>string</code> | <code>&quot;utf8&quot;</code> | The encoding of the file to be written as. |

<a name="writeFileSync"></a>

## writeFileSync(folder, name, extension, content, encoding)
